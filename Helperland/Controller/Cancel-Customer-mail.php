...
$body = "
  ...
  <h3 style='font-size:17px; color:red;'>Your Service Request Id is : <span style='color:blue;'>$ServiceRequestId</span> has been <span style='color:blue;'>cancel by $service_provider_name.</span><br>Please check it on Helperland.</h3><br>
