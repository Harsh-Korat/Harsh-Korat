...
$body = "
  ...
  <h3 style='font-size:17px; color:red;'>Your Service Request Id is : <span style='color:blue;'>$ServiceRequestId</span> has been completed by <span style='color:blue;'>$service_provider_name.</span>Please check it on Helperland.</h3><br>
