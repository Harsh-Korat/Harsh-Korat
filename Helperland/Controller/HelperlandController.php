 ...
 public function ProviderName()
    {
        ...
        if (isset($_POST)) {
            ...
            $result = $this->model->ProviderName($email);
            $username = $result[0];
...
public function FavouritePros()
    {
        ...
        if (isset($_POST)) {
            ...
            if (count($result)) {
                foreach ($result as $row) {
                    ...
                    $target_userid = $row['TargetUserId'];
                        ...
                        if($Provider_img == ''){
                        $Provider_img1 = '../assets/image/forma-1-copy-19.png"';
                        $Pro_class = 'round';
           ...
           $Address = 
                  ...
                  '<section class="block">
                    <div class="'.$Pro_class.' text-center" >
   ...
   public function AdminSearchUsermanagement()
    {
        ...
        if (isset($_POST)) {
            ...
            }else if($from_date == '' && $to_date == '' && $select == '' && $user_type != ''){

           $result = $this->model->AdminSearchUsermanagement1234($select,$user_type,$from_date,$to_date);

            }

            else if($from_date != '' && $to_date != '' && $select == '' && $user_type == ''){

           $result = $this->model->AdminSearchUsermanagement123($select,$user_type,$from_date,$to_date);

            }else if($from_date == '' && $to_date == '' && ($select != '' || $select == '') && ($user_type != '' || $user_type == '')){

            $result = $this->model->AdminSearchUsermanagement111($select,$user_type,$from_date,$to_date);
            }
            else{
 ...
 public function AdminFindPostalCode()
    {
        ...
        if (isset($_POST)) {
            ...
            if($zip == '' && $sid == '' && $customer == '' && $status == '' && $from_date == '' && $to_date == ''){
             ...
             $result = $this->model->AdminServiceRequests();
            }else if($zip == '' && $sid == '' && $customer == '' && $status == '' && ($from_date != '' && $to_date != '')){

             $result = $this->model->AdminFindPostalCodeRowCount111($zip,$sid,$customer,$status,$from_date,$to_date);
            
            }else if($zip == '' && $sid == '' && $customer == '' && $status != '' &&  $from_date == '' && $to_date == ''){

             $result = $this->model->AdminFindPostalCodeRowCount222($zip,$sid,$customer,$status,$from_date,$to_date);
            
            }else if($zip == '' && $sid == '' && $customer != '' && $status == '' &&  $from_date == '' && $to_date == ''){

             $result = $this->model->AdminFindPostalCodeRowCount333($zip,$sid,$customer,$status,$from_date,$to_date);
            }else if($zip == '' && $sid != '' && $customer == '' && $status == '' &&  $from_date == '' && $to_date == ''){

             $result = $this->model->AdminFindPostalCodeRowCount444($zip,$sid,$customer,$status,$from_date,$to_date);
            }else if($zip != '' && $sid == '' && $customer == '' && $status == '' &&  $from_date == '' && $to_date == ''){

             $result = $this->model->AdminFindPostalCodeRowCount555($zip,$sid,$customer,$status,$from_date,$to_date);
            }
