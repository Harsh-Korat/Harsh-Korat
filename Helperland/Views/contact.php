...
<div class="touch-container">
 <form method="POST" action=<?= $base_url."./?controller=Helperland&function=Contact"?>>
  ...
  <div class="clearfix">
   <div class="text">
    <div class="input-group">
      ...
      <input type="tel" style="width:242px;" class="form-control" id="mobilenum" placeholder="Mobile-number" name="mobile" autocomplete="off" required>
    </div>
