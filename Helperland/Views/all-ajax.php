            ...
            $.ajax({
                ...
                success: function(data) {
                     ...
                     if (data == 1) {
                         ...
                         window.location.href = "http://localhost/Helperland/Views/Customer-Servicehistory.php";
                      }

                      else if(data == 3) {
                         window.location.href = "http://localhost/Helperland/Views/ServiceProviderUpcomingService";
                      }
