      ...
      <div class="container mt-1">
        <form  method="POST">
         ...
         <div class="form-group mt-2 login-modals">
           <button type="submit" class="btn btn-login form-control booking-login">Login</button>
         </div>
        </form>
      </div>
  ...
  <div class="border-card">
    <div class="row payment-card">
       <div class="col-md-8 col-sm-7 col-6">
        <input type="text" name="credit-card" class="form-control card_number" placeholder="Card number" required size="16" id="cr_no" maxlength="16">
        <i class="fa fa-credit-card credit-card"></i>
        <span class="card-number-error text-danger mt-3"></span>
      </div>
     
       <div class="col-md-2 col-sm-3 col-3">
        <input type="text" id="expiry-date" name="expiry-date" class="form-control dates" size="5" maxlength="5" placeholder="MM/YY" required />
