  ...
  <div class="service">Extra Services</div>
    <div class="service-flex">
      <div class="services-left">
         <div class="first-img first"><img class="firsstservice" id="firstservice" src="../assets/image/3.png" alt=""></div>
         <div class="first-text">Inside cabinets</div>
      </div>

      <div class="services-left">
         <div class="first-img second"><img class="secondservice" id="secondimg" src="../assets/image/5.png" alt=""></div>
         <div class="first-text">Inside fridge</div>
      </div>

      <div class="services-left">
         <div class="first-img third" id="first"><img class="thirdservice" id="thirdimg" src="../assets/image/4.png" alt=""></div>
         <div class="first-text">Inside oven</div>
      </div>

      <div class="services-left">
         <div class="first-img fourth"><img class="fourthservice" id="fourthimg" src="../assets/image/2.png" alt=""></div>
         <div class="first-text">Laundry <br>wash & dry</div>
      </div>

      <div class="services-left">
         <div class="first-img fifth"><img class="fifthservice" id="fifthimg" src="../assets/image/1.png" alt=""></div>
...
<form>
  ...
  <p class="text-danger addresserror" style="font-size:18px; margin-bottom: 0px !important;"></p>
</form>
    ...
    <div class="row" id="address1">
      <div class="form-group col-md-6">
        <label class="street">Phone Number</label>
          ...
          <span class="mobile-msg text-danger"></span>
        </div>
       </div>
  ...
  <div class="card">
   <div class="payment">Payment Summary</div>
    <div class="card-body">
     ...
     <p class="card-text"><span class="date_time card-left">01/01/2018</span> @ <span class="times_date card-left" style="margin-left:15px; margin-right: 10px;">4:00 pm </span><br><span class="bed_num card-left"> 1 bed</span> ,  <span class="bath_num card-left" style="margin-left: 10px;">1 bath</span></p>
     ...
     <hr>
     <p class="duration" id="duration">Total Service Time <span class="total_requried_time">3.5 Hrs</span></p>
     <hr id="hrr">
...
<!-- Mobile modals -->
 ...
 <div class="modal fade" id="whatIncludes1" tabindex="-1" role="dialog" aria-labelledby="whatIncludesModal" aria-hidden="true" style="margin-left:20px;">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header payment">Payment Summary
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
  ...
  <div class="modal-body">   
    <div class="payment_main" style="margin-top: 0px;">
  <div>
   
 <div>
     <p class="card-text"><span class="date_time card-left">01/01/2018</span> @ <span class="times_date_modal card-left" style="margin-left: 15px; margin-right: 10px;">4:00 pm</span> <br><span class="bed_num_modal card-left">1 bed</span> , <span class="bath_num_modal" style="margin-left: 10px;">1 bath</span></p>
     <p class="duration">Duration</p>
     ...
     <hr>
     <p class="duration" id="duration">Total Service Time <span class="total_requried_time_modal">3.5 Hrs</span></p>
     <hr id="hrr">
     <p class="card-text subtotal">Per cleaning <span>$87</span></p>   
     <p class="card-text discount">Discount <span> - $27</span></p> 
     <hr id="hrr"> 
     <p class="card-text total" id="payment">Total Payment <span>$63</span></p> 
