...
$('.update').on("click", function(e) {
     ...
     if($("#dash_date").val() == "" || $("#dash_time").val() == ""){

    if ($("#dash_date").val() == "") {
       $(".dash_date").addClass('error-message').text("Please enter the Date.");
    }else {
       $(".dash_date").removeClass('error-message').text("");
    }

    if ($("#dash_time").val() == "") {
       $(".dash_time").addClass('error-message').text("Please enter the Time");
    }else {
       $(".dash_time").removeClass('error-message').text("");
    }
