...
<?php if(isset($_SESSION['err'])){
   ...
   <form method="POST" action=<?= $base_url . "./?controller=Helperland&function=ServiceProvider" ?>>
   ...
   <input type="tel" class="form-control"  id="mobilenum" name="mobile" placeholder="Phone Number" autocomplete="off" required>
   </div>
   ...
   <label class="form-check-label " for="terms">I accept <a href="#">terms and conditions</a> & <a href="#">privacy policy</a></label>
   </div>
      
   <div class="form-group sub-bttn">
   <button type="submit" class="btn sub-bttns">Get Started <img class="right-arrow" src="../assets/image/arrow-white.png"></button>
   </div>
...
<div class="down-bttn1">
  <img src="../assets/image/ellipse-525.svg" class="round1">
     <div class="download2">
       <img src="../assets/image/shape-1.svg" alt="" class="down-arrow">
  </div>
</div>
