...
<section class="form-start" id="bg">
 <div class="card reg-hd">
  <h1>Register Now!</h1>
   ...
   <input type="tel" class="form-control"  id="mobilenum" name="mobile" placeholder="Phone Number" autocomplete="off" maxlength="10">
   </div>
   ...
   <div class="form-group">
   <input type="password" class="form-control" id="cpassword" name="confirm-password" placeholder="Confirm Password">
   </div>
   ...
   <div class="form-check">
   <input type="checkbox" class="form-check-input condition" id="inlineFormCheck" name="check">
   <label class="form-check-label" for="inlineFormCheck">I accept <a href="#">terms and conditions</a> & <a href="#">privacy policy</a></label>
   </div>
   <div class="condition_err text-danger mb-2 checkbox-err" style="margin-left: 38px;"></div>
