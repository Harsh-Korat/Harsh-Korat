<?php include('./header.php'); ?>
     ...
     <link rel="stylesheet" href="../assets/css/provider-settings.css">
...
$('.provider-detail').on('click', function(e) {
    ...
    e.preventDefault();
    if ($("#nationallity").val() == "" || $('input[name=Gender]:checked').length == 0 || $('.avatar-img').hasClass('active1') == false  || $('#street').val() == "" || $("#houseno").val() == "" || $("#postalcode").val() == "") {
    ...
    if ($('.avatar-img').hasClass('active1') == false) {
 ...
 if ($("#currentpassword").val() == "" ||  $('#password').val() == "" || $("#cpassword").val() == "") {
    ...
    if ($("#cpassword").val() == "") {
      ...
      username = "<?php echo $_SESSION['username']; ?>";
        ...
        function ServiceProviderDetails() {
           ...
           $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#month').val(data[5]);
                    $('#year').val(data[6]);
                    $('.changedimg').attr('src',data[8])
                    $("#nationallity").val(data[9]);
                    $("input[name=Gender]").val([data[10]]);

                    $('.avtarimage').removeClass('active1');
                    for(i=0;i<6;i++){
            if(document.querySelectorAll('.avtarimage')[i].src == data[8]) {
       ...
       ServiceProviderDetails11();

        function ServiceProviderDetails11() {

       username = "<?php echo $_SESSION['username']; ?>";

           $.ajax({
                type: "POST",
                url: "http://localhost/Helperland/?controller=Helperland&function=ServiceProviderDetails11",
                data: {
                    username: username,
                },
                dataType: "json",
                success: function(data) {
                     ...
                     $("#street").val(data[0]);
                     $("#houseno").val(data[1]);
                     $("#postalcode").val(data[2]);
                     $("#location").html(data[3]);
  ...
  function CustomerDetails1() {
      location.href = "http://localhost/Helperland/Views/service-provider-setting.php";
   }   
...
function ServiceProviderDetails1(){
           ...
           lastname = $('#lastname').val();
            ...
            img = $('.avtarimage .active1').attr('src');
            img = img.slice(2)
            avtarimg = "http://localhost/Helperland/"+img;
            avtarimg = $('.avtarimage .active1').attr('src');
   ...
   ProviderName();
       ...
       username = "<?php echo $_SESSION['username']; ?>";
           ...
           $.ajax({
                type: "POST",
                url: "http://localhost/Helperland/?controller=Helperland&function=ProviderName",
                data: {
                    username: username,
                },
...
$(document).ready(function () {
    ...
    $('.avatar-img').on('click', function () {
        ...
        $('.avtarimage .avatar-img').removeClass('active1');
