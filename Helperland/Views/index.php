   ...
   <div class="modal-content">
     ...
     <div class="modal-body">
      <div class="container mt-1">
        <form  method="POST">
         <div class="mt-3">
           <input type="email" class="form-control" id="login" placeholder="E-Mail" name="email" autocomplete="off">
           <span><i class="fa fa-user mail"></i></span>
         </div>
    
         <div class="mt-3 mb-3">
           <input type="password" class="form-control" id="password" placeholder="Password" name="pswd">
           <span><i class="fa fa-lock locks"></i></span>
         </div>
      ...
      <div class="footer" id="creat-account"><a class="creat-account" href="#">Create an account</a></div>
      </div>
     </div>
    </div>
   </div>
...
<!-- Footer -->
 ...
 <section class="nsletter text-center ">
   <div class="whatsapp">
    <img src="../assets/image/layer-598.png">
   </div>
